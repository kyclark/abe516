...
1. "C": Four samples fed heat killed (HK) E. coli OP50 (because “live E. coli is pathogenic to C. elegans on BHI agar, the rich medium required for E. faecalis and E. faecium growth” [Ausubel])
2. "Bs": Three fed live B. subtilis PY79
3. "Efs": Three fed live E. faecalis MMH594
4. "Efm": Three fed live E. faecium E007
...
```{r maplotraw, message = FALSE, warning = FALSE}
